...
// MultSimple is an operation that will multiple two m of any size (m X k) and (k X n) together
...
// Add is an operation that will add two m together
...
// Sub is an operation that will subtract two m from one another
